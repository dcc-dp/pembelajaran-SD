...
@section('title', 'Edit Semester: ' . $semester->nama)
@section('page-title', 'Edit Semester')
@section('page-description', 'Perbarui data semester pembelajaran.')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header py-3 bg-white border-bottom">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h3 class="card-title fw-bold text-dark mb-0">Formulir Edit Semester</h3>
                        </div>
                    </div>
