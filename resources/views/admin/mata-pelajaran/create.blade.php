...
@section('page-description', 'Tambahkan data mata pelajaran baru untuk kurikulum sekolah dasar.')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header py-3 bg-white border-bottom">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h3 class="card-title fw-bold text-dark mb-0">Formulir Mata Pelajaran</h3>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input
                                    ...
                                    value="{{ old('nama') }}"
                                    placeholder="Contoh: Pendidikan Pancasila, IPAS, Bahasa Indonesia..."
                                    required
                                >
                                @error('nama')
