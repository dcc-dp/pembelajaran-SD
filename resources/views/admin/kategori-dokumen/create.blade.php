...
@section('page-description', 'Tambahkan klasifikasi kelompok file bahan ajar pada repository.')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header py-3 bg-white border-bottom">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h3 class="card-title fw-bold text-dark mb-0">Formulir Kategori Dokumen</h3>
                        </div>
                    </div>
