...
@section('page-actions')
    ...
    <a href="{{ route('admin.kelas.index') }}" class="btn btn-light border rounded-pill px-4 ms-2">
            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-footer bg-light py-3 d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.kelas.edit', $kelas) }}" class="btn btn-primary btn-sm rounded-pill px-3">
                            <x-admin-icon name="edit" />
                            <span class="ms-1">Edit</span>
                        </a>
                        <a href="{{ route('admin.kelas.index') }}" class="btn btn-light border btn-sm rounded-pill px-3">
                            Kembali
                        </a>
                    </div>
                </div>
