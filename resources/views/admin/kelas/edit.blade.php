...
@section('page-description', 'Perbarui data tingkatan kelas SD.')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header py-3 bg-white border-bottom">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h3 class="card-title fw-bold text-dark mb-0">Formulir Edit Kelas</h3>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                <small class="form-hint">Menentukan urutan tingkatan kelas (misal: 1 s/d 6).</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select
                                    ...
                                    required
                                >
                                    <option value="aktif" @selected(old('status', $kelas->status) === 'aktif')>
                                        Aktif
                                    </option>
                                    <option value="tidak_aktif" @selected(old('status', $kelas->status) === 'tidak_aktif')>
                                        Tidak Aktif
                                    </option>
                                </select>
                                @error('status')
