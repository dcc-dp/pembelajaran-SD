...
@section('page-description', 'Tambahkan tingkatan kelas SD baru untuk pengelompokan materi pembelajaran.')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header py-3 bg-white border-bottom">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h3 class="card-title fw-bold text-dark mb-0">Formulir Kelas</h3>
                        </div>
                    </div>
